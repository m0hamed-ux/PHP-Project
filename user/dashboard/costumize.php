    ...
    <div class="flex flex-1 overflow-hidden rounded-t-lg ">
        ...
        <main class="h-screen overflow-hidden w-full bg-gray-100 flex">
                ...
                <div class="max-w-4xl mx-auto bg-[--theme-bg] text-[--theme-text] shadow-lg">
                    <header class="border-b border-[--theme-outline] p-4 flex items-center gap-6">
                        ...
                        <nav class="flex space-x-6">
                            <a href="#" class="text-[--theme-secondary-text] hover:text-[--theme-secondary-hover]">Home</a>
                            <a href="#" class="text-[--theme-secondary-text] hover:text-[--theme-secondary-hover]">Shop</a>
                            <a href="#" class="text-[--theme-secondary-text] hover:text-[--theme-secondary-hover]">About</a>
                    ...
                    <div class="p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-[--theme-card-bg] rounded-lg shadow-md overflow-hidden">
                                ...
                                <div class="p-4">
                                    <h3 class="text-lg font-medium text-[--theme-text]">Product Name</h3>
                                    <p class="mt-1 text-sm text-[--theme-secondary-text]">$99.99</p>
                            ...
                            <div class="bg-[--theme-card-bg] rounded-lg shadow-md overflow-hidden">
                                ...
                                <div class="p-4">
                                    <h3 class="text-lg font-medium text-[--theme-text]">Product Name</h3>
                                    <p class="mt-1 text-sm text-[--theme-secondary-text]">$149.99</p>
                                    <button class="mt-4 w-full bg-[--theme-primary] text-[--theme-btn-text] hover:bg-[--theme-btn-hover] py-2 px-4 rounded-md transition-colors">
                                        Add to Cart
                                    </button>
                                </div>
                            ...
                            <div class="bg-[--theme-card-bg] rounded-lg shadow-md overflow-hidden">
                                ...
                                <div class="p-4">
                                    <h3 class="text-lg font-medium text-[--theme-text]">Product Name</h3>
                                    <p class="mt-1 text-sm text-[--theme-secondary-text]">$199.99</p>
                                    <button class="mt-4 w-full bg-[--theme-primary] text-[--theme-btn-text] hover:bg-[--theme-btn-hover] py-2 px-4 rounded-md transition-colors">
                                        Add to Cart
                                    </button>
                                </div>
            ...
            <form class="w-[30%] bg-white border-l overflow-auto pb-12 h-screen " action="" method="POST" enctype="multipart/form-data">
                <h1 class="font-medium border-b p-3">Home page</h1>
                <ul class="p-3">
                    <li class="font-medium text-sm ">
                        ...
                        <ul class="py-2">
                            <li class="text-gray-600">
                                ...
                                <label for="banner" class="bg-gray-200 px-2 py-1 block w-min ml-4 mt-1 rounded">Select</label>
                            </li>
                            <li class="text-gray-600 mt-2">
                                ...
                                <input type="text" name="heading" id="heading" 
                                    ...
                                    placeholder="Enter heading text" value="<?=$storeInfo['heading_text']?>">
                            </li>
                            <li class="text-gray-600 mt-2">
                                ...
                                <input type="text" name="sub-heading" id="sub-heading" 
                                    class="px-2 py-1 block w-[calc(100%-16px)] ml-4 mt-1 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                    placeholder="Enter sub-heading text" value="<?=$storeInfo['sub_heading_text']?>">
                            </li>
                        </ul>
                    </li>
                </ul>
                <ul class="p-3">
                    <li class="font-medium text-sm " id="themes">
                        Theme
                        <p class="text-gray-600 font-normal">Color schemes can be applied to sections throughout your online store.</p>
            ...
            <div class="flex justify-end p-4 border-t border-gray-200">
                <input name="save_changes" value="Save changes" type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition-colors">
            </div>
            </form>
        </main>
